...
const Tile = ({ word, color, onPress, disabled }) => (
  <button
    ...
    className={`flex flex-col items-center justify-center gap-1 rounded-2xl border-2 p-2 aspect-square text-center transition-transform active:scale-95 disabled:opacity-40 disabled:active:scale-100 ${CATEGORY_COLOR_CLASSES[color]}`}
  >
